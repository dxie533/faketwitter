...
router.get("/searchpage",async function(req,res){
	...
	"<h1>Search for posts</h1><br/>Search for post with content:<input type = 'text' id = 'searchQuery'></input><br/>Filter search by username:<input type = 'text' id = 'usernameOnly'></input></br>"+loggedInString+"Get all posts on or before unix time:<input type = 'number' id = 'timestamp'</input><br/>Filter by parent id:<input type = 'text' id = 'parentIdSearch'></input><br/><input type='checkbox' id='repliesBox' value='searchReplies' checked>Replies</input><br/><input type='checkbox' id='mediaBox' value='searchMedia'>Contains media</input><br/><input id = 'radioTime' type = 'radio' name = 'radioSearch' value = 'time'>Order by time<br/><input id = 'radioInterest' type = 'radio' name = 'radioSearch' value = 'interest' checked = 'true'>Order by Interest</input><br/><br/>Number of items to search for (Max 100):<input type = 'number' max:'100' min:'1' id = 'count' value='25'></input><button onclick = 'search()'>Execute Search</button><br/><h1>Search Result</h1><div id = 'searchResult'></div><br/></body></html>";
